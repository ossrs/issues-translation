...
parser.add_argument("--isf", type=str, default='issue', required=False, help="The filter can be [issue, pr, pullrequest, disscussion], for example, issue")
...
if 'issue' in args.isf:
    script = "srs/issue.sh"
elif 'pr' or 'pullrequest' in args.isf:
    script = "srs/pr.sh"
